    ...
    class gplot
    {
        ...
        public:
            ...
            gplot()
            {
                ...
                //#define term "aqua"
#else
#error Only Windows and Linux/__linux__ is supported so far!
#endif
                if(!gnucmd)
                {
...
//                std::cout << tmp.c_str() << std::endl;
            ...
            ///
            ////////////////////////////////////////////////////////////////////////////////////////////
            void add_rect(const double xmin, const double xmax)
            {
                std::ostringstream tmp_s;
                tmp_s << "set style rect fc lt -1 fs solid 0.15 noborder";
                std::string s = tmp_s.str();
                send2gp(s.c_str());
                std::ostringstream tmp_ss;
                tmp_ss << "set obj rect from " << xmin << ", graph 0 to " << xmax << ", graph 1";
                s = tmp_ss.str();
                send2gp(s.c_str());
            }
